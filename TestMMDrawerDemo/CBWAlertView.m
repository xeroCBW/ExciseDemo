...
static float const separatorMargin = 1.0;//iphone6+不会消失
...
#define marginColor [UIColor colorWithRed:196.0/255 green:196.0/255 blue:201.0/255 alpha:1.0]//[UIColor groupTableViewBackgroundColor];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<self.items.count; i++) {
        ...
        [closeButton.titleLabel setFont:[UIFont systemFontOfSize:font]];
...
//        scale.initialVelocity = 1.1;
        ...
        [UIView animateWithDuration:1 delay:0.0 usingSpringWithDamping:0.5 initialSpringVelocity:5 options:0 animations:^{
